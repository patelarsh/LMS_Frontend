...
function LawForgotPassword() {
    ...
    const handlesubmit = (e) => {
        ...
        if (email === "") {
            ...
            axios.post("https://lawyer-management-system-api.onrender.com/lawyer/forgot-password",
                {
                    email: email
                }
            )
            ...
            <div className="d-flex flex-wrap gap-4">
                ...
                <div className="col-12 col-lg-3 mb-5 mb-lg-0  row px-2 px-lg-4 mx-0">
                    ...
                    <div className="card-body py-5 px-md-5">
                        <h3 className="text-center my-4 fw-bold">Lawyer Forgot Password</h3>
...
export default LawForgotPassword;
